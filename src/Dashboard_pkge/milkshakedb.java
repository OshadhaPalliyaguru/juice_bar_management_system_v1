 ...
 * @author User1
 */
public class milkshakedb extends javax.swing.JFrame {

    /**
     * Creates new form milkshakedb
     */
    public milkshakedb() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("NEW MILK-SHAKE REGISTRATION");
    ...
    private void signinbtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signinbtn1ActionPerformed
        try {
            ...
            String sql = "INSERT INTO  milkshakes (productname, price, type, suppliyer, description, photo, productid) VALUES (?, ?, ?, ?, ?, ?, ? )";
   ...
   ste.setString(1, pname);         
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(milkshakedb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new milkshakedb().setVisible(true);
            }
        });
    }
