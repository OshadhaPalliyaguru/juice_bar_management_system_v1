 ...
 * @author User1
 */
public class deleteice extends javax.swing.JFrame {

    /**
     * Creates new form deleteice
     */
    public deleteice() {
        initComponents();
    }
...
//    ste.setInt(11, empid);
    ...
    private void signinbtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signinbtn1ActionPerformed
        try {
            ...
            String sql = "DELETE FROM icecream WHERE itemid = '"+itemdid+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deleteice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
