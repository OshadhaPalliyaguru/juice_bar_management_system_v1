 ...
 * @author User1
 */
public class deletemilkshake extends javax.swing.JFrame {

    /**
     * Creates new form deletemilkshake
     */
    public deletemilkshake() {
        initComponents();
    }
    public void data1(){
    int itemid = Integer.parseInt(itemidtxt.getText());
        ...
        try {
             String sql = "Select * from milkshakes where itemid = '"+itemid+"'";
...
//    ste.setInt(11, empid);
    ...
    private void signinbtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signinbtn1ActionPerformed
        try {
            ...
            String sql = "DELETE FROM milkshakes WHERE itemid = '"+itemdid+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deletemilkshake.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deletemilkshake().setVisible(true);
            }
        });
    }
