 ...
 * @author User1
 */
public class adminfoodjuiceslogin extends javax.swing.JFrame {

    /**
     * Creates new form adminfoodjuiceslogin
     */
    public adminfoodjuiceslogin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminfoodjuiceslogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminfoodjuiceslogin().setVisible(true);
            }
        });
    }
