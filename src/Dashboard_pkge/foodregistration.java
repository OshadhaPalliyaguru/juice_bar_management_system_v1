...
public class foodregistration extends javax.swing.JFrame {
    ...
    /**
     * Creates new form foodregistration
     */
    ...
    private void initComponents() {
        ...
        jPanel1.add(pricetxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 370, 360, 30));
        ...
        jLabel6.setText("NEW FOOD REGISTRATION");
        ...
        jPanel1.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 360, -1, -1));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 330, -1, -1));
        ...
        jPanel1.add(signinbtn4, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 510, -1, -1));
        ...
        errormsg1.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        errormsg1.setForeground(new java.awt.Color(255, 0, 0));
        errormsg1.setText("Product Name Required");
        jPanel1.add(errormsg1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 700, -1, -1));

        errormsg2.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        errormsg2.setForeground(new java.awt.Color(255, 0, 0));
        errormsg2.setText("Product Name Required");
        jPanel1.add(errormsg2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 410, -1, -1));
        ...
        jPanel1.add(errormsg3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 480, -1, -1));

        errormsg4.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        errormsg4.setForeground(new java.awt.Color(255, 0, 0));
        errormsg4.setText("Product Name Required");
        jPanel1.add(errormsg4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 260, -1, -1));

        errormsg5.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        errormsg5.setText("Image SIze Should Be 250 *210px");
        jPanel1.add(errormsg5, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 480, -1, -1));
    ...
    errormsg2.setText("Item Price Required");
    
}else if (suppliertxt.getText().isEmpty()) {  
    errormsg1.setText("Supplier name Required");
    ...
    String sql = "INSERT INTO item (productname, price, type, suppliyer, desvription, photo) VALUES (?, ?, ?, ?, ?, ? )";
...
try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(foodregistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
