 ...
 * @author User1
 */
public class updatemilkshake extends javax.swing.JFrame {

    /**
     * Creates new form updatemilkshake
     */
    public updatemilkshake() {
        initComponents();
    }
public void data1(){
...
//    ste.setInt(11, empid);
    ...
    private void signinbtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signinbtn1ActionPerformed
        try {
            ...
            StringBuilder sql = new StringBuilder("UPDATE milkshakes SET ");
            ...
            try {
                ...
                if(test == 1){
                    ...
                    String sql2 = "UPDATE milkshakes SET photo = ? where itemid = ?  ";
                    Connection con = dbconnection.dbconnection();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updatemilkshake.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updatemilkshake().setVisible(true);
            }
        });
    }
