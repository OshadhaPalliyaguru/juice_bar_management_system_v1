 ...
 * @author User1
 */
public class icreamdb extends javax.swing.JFrame {

    /**
     * Creates new form icreamdb
     */
    public icreamdb() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("NEW ICE - CREAM REGISTRATION");
    ...
    private void signinbtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signinbtn1ActionPerformed
        try {
            ...
            String sql = "INSERT INTO  icecream (productname, price, type, suppliyer, description, photo, productid) VALUES (?, ?, ?, ?, ?, ?, ? )";
   ...
   ste.setString(1, pname);         
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(icreamdb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
