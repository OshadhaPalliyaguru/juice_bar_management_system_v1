...
try {
   ...
   if (itemIdText.isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Item ID is Required");
            return;
        }
        ...
        StringBuilder sql = new StringBuilder("UPDATE juices SET ");
 ...
 try {
     ...
     String sql2 = "UPDATE juices SET photo = ? where itemid = ?  ";
        ...
        JOptionPane.showMessageDialog(rootPane, "Enter Valid Numbers");
    } catch (Exception e) {
        e.printStackTrace();
    } 
