 ...
 * @author User1
 */
public class updatesmoothie extends javax.swing.JFrame {

    /**
     * Creates new form updatesmoothie
     */
    public updatesmoothie() {
        initComponents();
    }
    public void data1(){
...
//    ste.setInt(11, empid);
    ...
    private void signinbtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signinbtn1ActionPerformed
        try {
            ...
            StringBuilder sql = new StringBuilder("UPDATE smoothiees SET ");
            ...
            try {
                ...
                if(test == 1){
                    ...
                    String sql2 = "UPDATE smoothiees SET photo = ? where itemid = ?  ";
                    Connection con = dbconnection.dbconnection();
            ...
            if (rowsUpdated > 0) {
                System.out.println("smoothiees updated successfully.");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updatesmoothie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updatesmoothie().setVisible(true);
            }
        });
    }
